...
implements ActionListener, MouseMotionListener, Runnable, WindowListener {
    ...
    private class ImagePanel extends JPanel {
        ...
        public ImagePanel(Image image) {
            ...
            int test = rand.nextInt(6);
            switch(test){
                case 1 : backgroundColor = (Color.ORANGE);
                break;

                case 2 :  backgroundColor = (Color.GRAY);
                break;

                case 3 :  backgroundColor = (Color.WHITE);
                break;

                case 4 :  backgroundColor = (Color.DARK_GRAY);
                break;

                case 5 :  backgroundColor = (Color.BLACK);
                break;
            }
